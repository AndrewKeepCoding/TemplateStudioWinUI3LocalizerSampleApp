...
public sealed partial class ShellPage : Page
{
    ...
    private void NavigationViewControl_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        {
            WinUI3Localizer.Uids.SetUid(settingsItem, "ShellPage_NavigationView_Settings");
        }
    }
    ...
    private void MainWindow_Activated(object sender, WindowActivatedEventArgs args)
    {
        ...
        WinUI3Localizer.Localizer.Get().LanguageChanged += ShellPage_LanguageChanged;
    }

    private void ShellPage_LanguageChanged(object? sender, WinUI3Localizer.LanguageChangedEventArgs e)
    {
        AppTitleBarText.Text = "AppDisplayName".GetLocalizedString();
    }
