...
using TemplateStudioWinUI3LocalizerSampleApp.Core.Helpers;
...
{
    private const string _defaultApplicationDataFolder = "TemplateStudioWinUI3LocalizerSampleApp/ApplicationData";
